!function(t) {
    ...
    a.prototype.initMaxLength=function() {
        t("input#defaultconfig").maxlength( {
            warningClass: "badge badge-success", limitReachedClass: "badge badge-danger"
        }
        ),
        t("input#thresholdconfig").maxlength( {
            threshold: 20, warningClass: "badge badge-success", limitReachedClass: "badge badge-danger"
        }
        ),
        t("input#alloptions").maxlength( {
            alwaysShow: !0, separator: " out of ", preText: "You typed ", postText: " chars available.", validate: !0, warningClass: "badge badge-success", limitReachedClass: "badge badge-danger"
        }
        ),
        t("textarea#textarea").maxlength( {
            alwaysShow: !0, warningClass: "badge badge-success", limitReachedClass: "badge badge-danger"
        }
        ),
        t("input#placement").maxlength( {
            alwaysShow: !0, placement: "top-left", warningClass: "badge badge-success", limitReachedClass: "badge badge-danger"
        }
        )
    }
    ,
    // a.prototype.initCustomSelect=function() {
...
$(function() {
    ...
    // );
    // $.mockjax( {
    //     url:"*", responseTime:2e3, response:function(a) {
    //         var e=a.data.query, n=e.toLowerCase(), i=new RegExp("\\b"+$.Autocomplete.utils.escapeRegExChars(n), "gi"), t= {
    //             query:e, suggestions:$.grep(o, function(a) {
    ...
    //     lookup:o, lookupFilter:function(a, e, n) {
